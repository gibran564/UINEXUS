  ...
  return (
    <footer className="mt-24 border-t border-line bg-surface">
      <div className="container-page grid gap-8 py-10 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          {/* El mismo wordmark que la barra: una marca que se dibuja distinto en
              cada esquina es dos marcas. */}
          <p className="text-h3">
            <Wordmark size={18} />
          </p>
          <p className="mt-2 max-w-64 text-sm text-muted">
            Aprende construyendo. Código, laboratorios, proyectos y clases en un solo espacio.
          </p>
        </div>
        ...
        <nav aria-labelledby="footer-acerca">
          ...
          <ul className="text-sm">
            <FooterLink href="/about">Acerca de Nextudio</FooterLink>
