 ...
 *
 * Vive aquí y no en `app/page.tsx` porque ahora `/` decide a quién enseña qué:
 * el visitante ve esto y quien tiene sesión ve su Inicio. Los datos se siguen
 * cargando en el servidor y entran por props, así que para quien llega de
 * fuera —o de un buscador— sigue siendo HTML completo.
 */
